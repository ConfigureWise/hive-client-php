<?php
/**
 * GetManufacturerContactsResponse
 *
 * PHP version 8.1
 *
 * @category Class
 ...
 */
class GetManufacturerContactsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetManufacturerContactsResponse';
    ...
    */
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling GetManufacturerContactsResponse., number of items must be greater than or equal to 1.');
        }
