 ...
 */
class PutFeature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PutFeature';
    ...
    */
    ...
    public function setDescriptions($descriptions)
    {
        ...
        if ((count($descriptions) < 1)) {
            throw new \InvalidArgumentException('invalid length for $descriptions when calling PutFeature., number of items must be greater than or equal to 1.');
        }
