<?php
/**
 * RequestPostComponentAttachmentsBulkUpsert
 *
 * PHP version 8.1
 *
 * @category Class
 ...
 */
class RequestPostComponentAttachmentsBulkUpsert implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestPostComponentAttachmentsBulkUpsert';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['attachments']) > 25)) {
            $invalidProperties[] = "invalid value for 'attachments', number of items must be less than or equal to 25.";
        }
    ...
    public function setAttachments($attachments)
    {
        ...
        if ((count($attachments) > 25)) {
            throw new \InvalidArgumentException('invalid value for $attachments when calling RequestPostComponentAttachmentsBulkUpsert., number of items must be less than or equal to 25.');
        }
