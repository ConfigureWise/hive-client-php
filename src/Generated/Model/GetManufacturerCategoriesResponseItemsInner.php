<?php
/**
 * GetManufacturerCategoriesResponseItemsInner
 *
 * PHP version 8.1
 *
 * @category Class
 ...
 */
class GetManufacturerCategoriesResponseItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetManufacturerCategoriesResponse_items_inner';
    ...
    protected static $attributeMap = [
        ...
        'name' => 'name',
        'type' => 'type',
        'parent_main_category' => 'parentMainCategory',
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'type' => 'setType',
        'parent_main_category' => 'setParentMainCategory',
    ...
    protected static $getters = [
        ...
        'name' => 'getName',
        'type' => 'getType',
        'parent_main_category' => 'getParentMainCategory',
    ...
    public const TYPE_SUB_CATEGORY = 'SUB_CATEGORY';
    ...
    {
        return [
            self::TYPE_MAIN_CATEGORY,
            self::TYPE_SUB_CATEGORY,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('parent_main_category', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID of the category.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code Code of the category.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The translated name of the category.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type of category.
     *
     * @return self
     */
    ...
    {
        return $this->container['parent_main_category'];
    }
     ...
     * @return self
     */
    public function setParentMainCategory($parent_main_category)
    {
        if (is_null($parent_main_category)) {
            throw new \InvalidArgumentException('non-nullable parent_main_category cannot be null');
        }
        $this->container['parent_main_category'] = $parent_main_category;
