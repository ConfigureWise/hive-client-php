...
/**
 * ProjectSegmentOrderInvoice Class Doc Comment
 *
 * @category Class
 * @description All information to allow the manufacturer make the invoice.
 * @package  HiveCpq\Client\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProjectSegmentOrderInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectSegment_order_invoice';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('company_vat_number', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $company_vat_number company_vat_number
     *
     * @return self
     */
    public function setCompanyVatNumber($company_vat_number)
    {
        if (is_null($company_vat_number)) {
            throw new \InvalidArgumentException('non-nullable company_vat_number cannot be null');
        }
