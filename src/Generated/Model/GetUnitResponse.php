...
/**
 * GetUnitResponse Class Doc Comment
 *
 * @category Class
 * @package  HiveCpq\\Client\\Generated
 * @author   OpenAPI Generator team
 ...
 */
class GetUnitResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetUnitResponse';
    ...
    */
    ...
    public function setNames($names)
    {
        ...
        if ((count($names) < 1)) {
            throw new \InvalidArgumentException('invalid length for $names when calling GetUnitResponse., number of items must be greater than or equal to 1.');
        }
