 ...
 *
 * @category Class
 * @description Link object used when referencing a contact from another entity.
 * @package  HiveCpq\\Client\\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ContactLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Hive id of the contact
     *
     * @return self
     */
     ...
     * Sets href
     *
     * @param string|null $href Href for a contact will be /manufacturers/{manufacturerId}/contacts/{contactId}
     *
     * @return self
     */
     ...
     * Sets full_name
     *
     * @param string|null $full_name First and last name of the contact
     *
     * @return self
     */
