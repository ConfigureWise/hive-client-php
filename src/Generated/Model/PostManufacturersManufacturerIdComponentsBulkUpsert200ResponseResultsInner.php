<?php
/**
 * PostManufacturersManufacturerIdComponentsBulkUpsert200ResponseResultsInner
 *
 * PHP version 8.1
 *
 * @category Class
 ...
 */
class PostManufacturersManufacturerIdComponentsBulkUpsert200ResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_manufacturers_manufacturerId_components_bulkUpsert_200_response_results_inner';
    ...
    */
     ...
     * Sets item_id
     *
     * @param string|null $item_id Custom identifier of this item.
     *
     * @return self
     */
     ...
     * Sets resource_id
     *
     * @param string|null $resource_id ID of the created or updated resource.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Message with additional information if the item failed to be handled.
     *
     * @return self
     */
