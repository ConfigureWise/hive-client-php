<?php
/**
 * GetManufacturerContactExternalLinksResponse
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetManufacturerContactExternalLinksResponse Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  HiveCpq\\Client\\Generated
 ...
 */
class GetManufacturerContactExternalLinksResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetManufacturerContactExternalLinksResponse';
    ...
    */
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling GetManufacturerContactExternalLinksResponse., number of items must be greater than or equal to 1.');
        }
