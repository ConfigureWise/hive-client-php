<?php
/**
 * ResponseGetSupportedLanguagesItemsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResponseGetSupportedLanguagesItemsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseGetSupportedLanguagesItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseGetSupportedLanguages_items_inner';
    ...
    */
     ...
     * Sets iso_code
     *
     * @param string|null $iso_code ISO code of the language.
     *
     * @return self
     */
     ...
     * Sets native_name
     *
     * @param string|null $native_name Native name of the language.
     *
     * @return self
     */
    public function setNativeName($native_name)
    {
        if (is_null($native_name)) {
            throw new \InvalidArgumentException('non-nullable native_name cannot be null');
        }
