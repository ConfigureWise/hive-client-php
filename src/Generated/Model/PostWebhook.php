 ...
 */
class PostWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostWebhook';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code The unique code of the webhook
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url The url that will be invoked when calling the webhook
     *
     * @return self
     */
