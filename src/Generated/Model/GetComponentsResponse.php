...
/**
 * GetComponentsResponse Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  HiveCpq\Client\Generated
 ...
 */
class GetComponentsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetComponentsResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\HiveCpq\Client\Generated\Model\ComponentLimited[]',
        'total' => 'float'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \HiveCpq\Client\Generated\Model\ComponentLimited[]
     */
     ...
     * Sets items
     *
     * @param \HiveCpq\Client\Generated\Model\ComponentLimited[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling GetComponentsResponse., number of items must be greater than or equal to 1.');
        }
