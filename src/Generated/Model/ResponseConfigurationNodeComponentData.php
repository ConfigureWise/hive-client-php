 ...
 */
class ResponseConfigurationNodeComponentData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseConfigurationNodeComponentData';
    ...
    */
    ...
    public function setNames($names)
    {
        ...
        if ((count($names) < 1)) {
            throw new \InvalidArgumentException('invalid length for $names when calling ResponseConfigurationNodeComponentData., number of items must be greater than or equal to 1.');
        }
    ...
    public function setDescriptions($descriptions)
    {
        ...
        if ((count($descriptions) < 1)) {
            throw new \InvalidArgumentException('invalid length for $descriptions when calling ResponseConfigurationNodeComponentData., number of items must be greater than or equal to 1.');
        }
