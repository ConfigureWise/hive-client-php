...
/**
 * ResponseGetConfigurationPrice Class Doc Comment
 *
 * @category Class
 * @package  HiveCpq\Client\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ResponseGetConfigurationPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseGetConfiguration_price';
    ...
    */
     ...
     * Sets list_price
     *
     * @param float|null $list_price List price of the configuration.
     *
     * @return self
     */
     ...
     * Sets purchase_price
     *
     * @param float|null $purchase_price Purchase price of the configuration.
     *
     * @return self
     */
     ...
     * Sets sales_price
     *
     * @param float|null $sales_price Sales price of the configuration.
     *
     * @return self
     */
