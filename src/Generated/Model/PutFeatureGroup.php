 ...
 */
class PutFeatureGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PutFeatureGroup';
    ...
    */
    ...
    public function setDescriptions($descriptions)
    {
        ...
        if ((count($descriptions) < 1)) {
            throw new \InvalidArgumentException('invalid length for $descriptions when calling PutFeatureGroup., number of items must be greater than or equal to 1.');
        }
