 ...
 */
class FeatureLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeatureLink';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The uniqe hive id of the feature
     *
     * @return self
     */
     ...
     * Sets href
     *
     * @param string|null $href Default /manufacturers/{manufacturerId}/featureGroups/{groupId}/features/{featureid}
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name in the default language.
     *
     * @return self
     */
