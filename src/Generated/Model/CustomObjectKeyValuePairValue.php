...
/**
 * CustomObjectKeyValuePairValue Class Doc Comment
 *
 * @category Class
 * @description The value can be any of the common data types available to custom objects
 * @package  HiveCpq\\Client\\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomObjectKeyValuePairValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomObjectKeyValuePair_value';
