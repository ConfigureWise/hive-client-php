 ...
 *
 * @category Class
 * @description All prices withinn HiveCPQ. This entails the list price, purchase price, sales price and discount
 * @package  HiveCpq\Client\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Price implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets list_price
     *
     * @param string|null $list_price This is the public list price.
     *
     * @return self
     */
     ...
     * Sets discount
     *
     * @param string|null $discount The discount percentage a distributor receives on that list price.
     *
     * @return self
     */
     ...
     * Sets purchase_price
     *
     * @param string|null $purchase_price The price the distributor has to pay the manufacturer.
     *
     * @return self
     */
     ...
     * Sets sales_price
     *
     * @param string|null $sales_price The price the distributor will sell to the end customer.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency The currency of the prices.
     *
     * @return self
     */
     ...
     * Sets markup
     *
     * @param string|null $markup The markup percentage.
     *
     * @return self
     */
