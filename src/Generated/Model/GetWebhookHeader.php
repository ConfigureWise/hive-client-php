...
/**
 * GetWebhookHeader Class Doc Comment
 *
 * @category Class
 * @package  HiveCpq\Client\Generated
 * @author   OpenAPI Generator team
 ...
 */
class GetWebhookHeader implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetWebhookHeader';
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key Unique key that will be added to the webhook
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The value that will be added to the header
     *
     * @return self
     */
