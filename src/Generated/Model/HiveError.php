 ...
 */
class HiveError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HiveError';
    ...
    {
        $this->setIfExists('hive_error', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getHiveError()
    {
        return $this->container['hive_error'];
    }

    /**
     * Sets hive_error
     *
     * @param string|null $hive_error hive_error
     *
     * @return self
     */
    public function setHiveError($hive_error)
    {
        if (is_null($hive_error)) {
            throw new \InvalidArgumentException('non-nullable hive_error cannot be null');
        }
        $this->container['hive_error'] = $hive_error;
