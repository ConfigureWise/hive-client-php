 ...
 */
class PutComponentTooltip implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PutComponentTooltip';
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Enable or disable the tooltip.
     *
     * @return self
     */
    ...
    public function setTitles($titles)
    {
        ...
        if ((count($titles) < 1)) {
            throw new \InvalidArgumentException('invalid length for $titles when calling PutComponentTooltip., number of items must be greater than or equal to 1.');
        }
    ...
    public function setDetails($details)
    {
        ...
        if ((count($details) < 1)) {
            throw new \InvalidArgumentException('invalid length for $details when calling PutComponentTooltip., number of items must be greater than or equal to 1.');
        }
