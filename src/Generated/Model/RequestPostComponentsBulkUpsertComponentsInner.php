<?php
/**
 * RequestPostComponentsBulkUpsertComponentsInner
 *
 * PHP version 8.1
 *
 * @category Class
 ...
 */
class RequestPostComponentsBulkUpsertComponentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestPostComponentsBulkUpsert_components_inner';
    ...
    */
     ...
     * Sets item_id
     *
     * @param string $item_id A custom identifier of this item that must be unique within the entire request. This is not the component ID.
     *
     * @return self
     */
    ...
    public function setNames($names)
    {
        ...
        if ((count($names) < 1)) {
            throw new \InvalidArgumentException('invalid length for $names when calling RequestPostComponentsBulkUpsertComponentsInner., number of items must be greater than or equal to 1.');
        }
    ...
    public function setDescriptions($descriptions)
    {
        ...
        if ((count($descriptions) < 1)) {
            throw new \InvalidArgumentException('invalid length for $descriptions when calling RequestPostComponentsBulkUpsertComponentsInner., number of items must be greater than or equal to 1.');
        }
     ...
     *
     * @param string|null $integrated_system_id Optional integrated system ID used to create an integrated system link for this component
     *
     * @return self
     */
