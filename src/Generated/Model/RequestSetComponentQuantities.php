 ...
 */
class RequestSetComponentQuantities implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestSetComponentQuantities';
    ...
    */
     ...
     *
     * @param string|null $integrated_system_name Optional. Only target units linked to an integrated system.
     *
     * @return self
     */
