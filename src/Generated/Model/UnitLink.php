 ...
 */
class UnitLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnitLink';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID of the unit.
     *
     * @return self
     */
     ...
     * Sets href
     *
     * @param string|null $href The url to the unit.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code The code of the unit.
     *
     * @return self
     */
