<?php
/**
 * GetCompanyDefaultAddressesResponse
 *
 * PHP version 8.1
 *
 * @category Class
 ...
 */
class GetCompanyDefaultAddressesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCompanyDefaultAddressesResponse';
    ...
    */
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling GetCompanyDefaultAddressesResponse., number of items must be greater than or equal to 1.');
        }
