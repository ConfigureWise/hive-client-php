 ...
 */
class ManufacturerFeature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManufacturerFeature';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code Unique code or id of the feature. Must be unique for the version, container and manufacturer
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description translated into the specific language.
     *
     * @return self
     */
