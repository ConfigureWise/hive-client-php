...
/**
 * PostFeatureGroup Class Doc Comment
 *
 * @category Class
 * @package  HiveCpq\Client\Generated
 * @author   OpenAPI Generator team
 ...
 */
class PostFeatureGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostFeatureGroup';
    ...
    */
    ...
    public function setDescriptions($descriptions)
    {
        ...
        if ((count($descriptions) < 1)) {
            throw new \InvalidArgumentException('invalid length for $descriptions when calling PostFeatureGroup., number of items must be greater than or equal to 1.');
        }
