<?php
/**
 * AddProjectConfigurationRequestBody
 *
 * PHP version 8.1
 *
 * @category Class
 ...
 */
class AddProjectConfigurationRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddProjectConfigurationRequestBody';
    ...
    protected static $getters = [
        ...
        'initial_values' => 'getInitialValues',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('initial_values', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the configuration
     *
     * @return self
     */
     ...
     *
     * @param string|null $configuration_code Unique code from another configuration from which a new configuration will be created.
     *
     * @return self
     */
    ...
    {
        return $this->container['initial_values'];
    }
     ...
     * @return self
     */
    public function setInitialValues($initial_values)
    {
        if (is_null($initial_values)) {
            throw new \InvalidArgumentException('non-nullable initial_values cannot be null');
        }
        $this->container['initial_values'] = $initial_values;
     ...
     * Sets container_name
     *
     * @param string|null $container_name Optionally choose a container from which the configurator should be used.
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param string|null $version Optionally choose a version from which the configurator should be used. This is the number of the version (e.g. 1.0.0) you want to access. Providing 'top' accesses the highest available version.
     *
     * @return self
     */
