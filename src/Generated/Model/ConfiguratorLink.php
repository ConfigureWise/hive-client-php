...
/**
 * ConfiguratorLink Class Doc Comment
 *
 * @category Class
 * @package  HiveCpq\Client\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ConfiguratorLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConfiguratorLink';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique hive id.
     *
     * @return self
     */
     ...
     * Sets href
     *
     * @param string|null $href Default /manufacturers/{manufacturerId}/configurators/{configuratorId}
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name name of the configurator in the default language
     *
     * @return self
     */
