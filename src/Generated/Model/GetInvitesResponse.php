...
/**
 * GetInvitesResponse Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  HiveCpq\Client\Generated
 ...
 */
class GetInvitesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInvitesResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\HiveCpq\Client\Generated\Model\Invite[]',
        'total' => 'float'
    ];
    ...
    */
     ...
     * Sets items
     *
     * @param \HiveCpq\Client\Generated\Model\Invite[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling GetInvitesResponse., number of items must be greater than or equal to 1.');
        }
