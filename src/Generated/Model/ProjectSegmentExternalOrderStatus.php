<?php
/**
 * ProjectSegmentExternalOrderStatus
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ProjectSegmentExternalOrderStatus Class Doc Comment
 *
 * @category Class
 * @package  HiveCpq\\Client\\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ProjectSegmentExternalOrderStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectSegment_externalOrderStatus';
    ...
    */
    ...
    public function setStatusUrl($status_url)
    {
        if (is_null($status_url)) {
            throw new \InvalidArgumentException('non-nullable status_url cannot be null');
        }
