...
/**
 * CompanyOrderManager Class Doc Comment
 *
 * @category Class
 * @package  HiveCpq\\Client\\Generated
 * @author   OpenAPI Generator team
 ...
 */
class CompanyOrderManager implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompanyOrderManager';
    ...
    {
        $this->setIfExists('manager_contact_id', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $manager_contact_id manager_contact_id
     *
     * @return self
     */
    public function setManagerContactId($manager_contact_id)
    {
        if (is_null($manager_contact_id)) {
            throw new \InvalidArgumentException('non-nullable manager_contact_id cannot be null');
        }
