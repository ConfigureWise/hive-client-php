 ...
 */
class ProductConfigurator implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductConfigurator';
    ...
    protected static $setters = [
        'id' => 'setId',
        'href' => 'setHref',
        'configuration_parameters' => 'setConfigurationParameters'
    ];
    ...
    protected static $getters = [
        'id' => 'getId',
        'href' => 'getHref',
        'configuration_parameters' => 'getConfigurationParameters'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('configuration_parameters', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['configuration_parameters'] === null) {
            $invalidProperties[] = "'configuration_parameters' can't be null";
        }
        if ((count($this->container['configuration_parameters']) < 1)) {
            $invalidProperties[] = "invalid value for 'configuration_parameters', number of items must be greater than or equal to 1.";
        }
    ...
    {
        return $this->container['configuration_parameters'];
    }
     ...
     * @return self
     */
    public function setConfigurationParameters($configuration_parameters)
    {
        if (is_null($configuration_parameters)) {
            throw new \InvalidArgumentException('non-nullable configuration_parameters cannot be null');
        }


        if ((count($configuration_parameters) < 1)) {
            throw new \InvalidArgumentException('invalid length for $configuration_parameters when calling ProductConfigurator., number of items must be greater than or equal to 1.');
        }
        $this->container['configuration_parameters'] = $configuration_parameters;
