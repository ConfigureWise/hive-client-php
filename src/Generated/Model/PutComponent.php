...
/**
 * PutComponent Class Doc Comment
 *
 * @category Class
 * @package  HiveCpq\\Client\\Generated
 * @author   OpenAPI Generator team
 ...
 */
class PutComponent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PutComponent';
    ...
    */
    ...
    public function setNames($names)
    {
        ...
        if ((count($names) < 1)) {
            throw new \InvalidArgumentException('invalid length for $names when calling PutComponent., number of items must be greater than or equal to 1.');
        }
    ...
    public function setDescriptions($descriptions)
    {
        ...
        if ((count($descriptions) < 1)) {
            throw new \InvalidArgumentException('invalid length for $descriptions when calling PutComponent., number of items must be greater than or equal to 1.');
        }
