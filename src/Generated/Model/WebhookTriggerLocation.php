...
class WebhookTriggerLocation
{
    ...
    public const PROJECT_SEGMENT = 'PROJECT_SEGMENT';

    public const PROJECT_SEGMENT_ITEM = 'PROJECT_SEGMENT_ITEM';
