...
/**
 * ShippingScheduleLink Class Doc Comment
 *
 * @category Class
 * @package  HiveCpq\\Client\\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ShippingScheduleLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShippingScheduleLink';
    ...
    public const TYPE_UPON_REQUEST = 'UPON_REQUEST';
    public const TYPE_SHIPPING_WEEK = 'SHIPPING_WEEK';
    ...
    {
        return [
            self::TYPE_UPON_REQUEST,
            self::TYPE_SHIPPING_WEEK,
        ];
    }
    ...
    */
     ...
     * Sets week
     *
     * @param int|null $week Week of the planned shipping.
     *
     * @return self
     */
     ...
     * Sets year
     *
     * @param int|null $year year of the planned shipping
     *
     * @return self
     */
