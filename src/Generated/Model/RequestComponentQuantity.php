...
/**
 * RequestComponentQuantity Class Doc Comment
 *
 * @category Class
 * @package  HiveCpq\Client\Generated
 * @author   OpenAPI Generator team
 ...
 */
class RequestComponentQuantity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestComponentQuantity';
    ...
    */
     ...
     * Sets unit_code
     *
     * @param string $unit_code Code of the unit to use for this component quantity.
     *
     * @return self
     */
     ...
     * Sets minimum
     *
     * @param float $minimum The minimum quantity to use for this component quantity.
     *
     * @return self
     */
     ...
     * Sets maximum
     *
     * @param float|null $maximum The optional maximum quantity to use for this component quantity.
     *
     * @return self
     */
     ...
     * Sets step
     *
     * @param float $step The step value to use for each incremental step for this component quantity. At the moment only a step of 1 is supported.
     *
     * @return self
     */
