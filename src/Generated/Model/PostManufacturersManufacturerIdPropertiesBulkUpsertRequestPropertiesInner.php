<?php
/**
 * PostManufacturersManufacturerIdPropertiesBulkUpsertRequestPropertiesInner
 *
 * PHP version 8.1
 *
 * @category Class
 ...
 */
class PostManufacturersManufacturerIdPropertiesBulkUpsertRequestPropertiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_manufacturers_manufacturerId_properties_bulkUpsert_request_properties_inner';
    ...
    */
     ...
     * Sets item_id
     *
     * @param string $item_id A custom identifier of this item that must be unique within the entire request. This is not the property ID.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string $code Unique code for the property.
     *
     * @return self
     */
     ...
     * Sets info
     *
     * @param string|null $info General info about the property.
     *
     * @return self
     */
     ...
     *
     * @param string|null $integrated_system_id Optional integrated system ID used to create an integrated system link for this property.
     *
     * @return self
     */
