<?php
/**
 * GetManufacturersComponentTooltip200Response
 *
 * PHP version 8.1
 *
 * @category Class
 ...
 */
class GetManufacturersComponentTooltip200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_manufacturers_component_tooltip_200_response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['titles']) && (count($this->container['titles']) < 1)) {
            $invalidProperties[] = "invalid value for 'titles', number of items must be greater than or equal to 1.";
        }
    ...
    public function setTitles($titles)
    {
        ...
        if ((count($titles) < 1)) {
            throw new \InvalidArgumentException('invalid length for $titles when calling GetManufacturersComponentTooltip200Response., number of items must be greater than or equal to 1.');
        }
    ...
    public function setDetails($details)
    {
        ...
        if ((count($details) < 1)) {
            throw new \InvalidArgumentException('invalid length for $details when calling GetManufacturersComponentTooltip200Response., number of items must be greater than or equal to 1.');
        }
