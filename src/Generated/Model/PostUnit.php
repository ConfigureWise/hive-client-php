 ...
 */
class PostUnit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostUnit';
    ...
    */
    ...
    public function setNames($names)
    {
        ...
        if ((count($names) < 1)) {
            throw new \InvalidArgumentException('invalid length for $names when calling PostUnit., number of items must be greater than or equal to 1.');
        }
