<?php
/**
 * GetCompanyExternalLinksResponse
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetCompanyExternalLinksResponse Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  HiveCpq\\Client\\Generated
 ...
 */
class GetCompanyExternalLinksResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCompanyExternalLinksResponse';
    ...
    */
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling GetCompanyExternalLinksResponse., number of items must be greater than or equal to 1.');
        }
