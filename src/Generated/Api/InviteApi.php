...
class InviteApi
{
    ...
    public const contentTypes = [
        'createManufacturerInvite' => [
            'application/json',
        ],
        'getManufacturerInvites' => [
            'application/json',
        ],
        'sendInviteEmail' => [
            'application/json',
    ...
    /**
     * Operation createManufacturerInvite
     *
    ...
    {
        list($response) = $this->createManufacturerInviteWithHttpInfo($manufacturer_id, $create_invite, $contentType);
        return $response;
    }

    /**
     * Operation createManufacturerInviteWithHttpInfo
     *
     * Create invite for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
    ...
    /**
     * Operation createManufacturerInviteAsync
     *
     * Create invite for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     ...
     */
    public function createManufacturerInviteAsync($manufacturer_id, $create_invite = null, string $contentType = self::contentTypes['createManufacturerInvite'][0])
    {
        return $this->createManufacturerInviteAsyncWithHttpInfo($manufacturer_id, $create_invite, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createManufacturerInviteAsyncWithHttpInfo
     *
     * Create invite for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     ...
     */
    public function createManufacturerInviteRequest($manufacturer_id, $create_invite = null, string $contentType = self::contentTypes['createManufacturerInvite'][0])
    {
        ...
        if ($manufacturer_id === null || (is_array($manufacturer_id) && count($manufacturer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $manufacturer_id when calling createManufacturerInvite'
            );
        }



        $resourcePath = '/manufacturers/{manufacturerId}/invites';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($create_invite)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_invite));
            } else {
                $httpBody = $create_invite;
            }
    ...
    /**
     * Operation getManufacturerInvites
     *
     * Get invites for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     * @param  string|null $contact_id Find by Hive contact Id (optional)
     * @param  string|null $integrated_system_name Filter on the integrated system name of the items. (optional)
     * @param  string|null $integrated_contact_system_id Find by the integrated system id of the contact (optional)
    ...
    {
        list($response) = $this->getManufacturerInvitesWithHttpInfo($manufacturer_id, $contact_id, $integrated_system_name, $integrated_contact_system_id, $status, $contentType);
        return $response;
    }

    /**
     * Operation getManufacturerInvitesWithHttpInfo
     *
     * Get invites for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
    ...
    /**
     * Operation getManufacturerInvitesAsync
     *
     * Get invites for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getManufacturerInvitesAsync($manufacturer_id, $contact_id = null, $integrated_system_name = null, $integrated_contact_system_id = null, $status = null, string $contentType = self::contentTypes['getManufacturerInvites'][0])
    {
        return $this->getManufacturerInvitesAsyncWithHttpInfo($manufacturer_id, $contact_id, $integrated_system_name, $integrated_contact_system_id, $status, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getManufacturerInvitesAsyncWithHttpInfo
     *
     * Get invites for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
    ...
    /**
     * Create request for operation 'getManufacturerInvites'
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     * @param  string|null $contact_id Find by Hive contact Id (optional)
     * @param  string|null $integrated_system_name Filter on the integrated system name of the items. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getManufacturerInvitesRequest($manufacturer_id, $contact_id = null, $integrated_system_name = null, $integrated_contact_system_id = null, $status = null, string $contentType = self::contentTypes['getManufacturerInvites'][0])
    {

        // verify the required parameter 'manufacturer_id' is set
        if ($manufacturer_id === null || (is_array($manufacturer_id) && count($manufacturer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $manufacturer_id when calling getManufacturerInvites'
            );
        }
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $integrated_contact_system_id,
            'integratedContactSystemId', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     *
     * Send invitation email using HiveCPQ&#39;s email system
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     ...
     * @return void
     */
    public function sendInviteEmail($manufacturer_id, $invite_id, $send_invite_email_request = null, string $contentType = self::contentTypes['sendInviteEmail'][0])
    {
        $this->sendInviteEmailWithHttpInfo($manufacturer_id, $invite_id, $send_invite_email_request, $contentType);
    }

    /**
     * Operation sendInviteEmailWithHttpInfo
     *
     * Send invitation email using HiveCPQ&#39;s email system
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     ...
     */
    public function sendInviteEmailWithHttpInfo($manufacturer_id, $invite_id, $send_invite_email_request = null, string $contentType = self::contentTypes['sendInviteEmail'][0])
    {
        $request = $this->sendInviteEmailRequest($manufacturer_id, $invite_id, $send_invite_email_request, $contentType);
    ...
    /**
     * Operation sendInviteEmailAsync
     *
     * Send invitation email using HiveCPQ&#39;s email system
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendInviteEmailAsync($manufacturer_id, $invite_id, $send_invite_email_request = null, string $contentType = self::contentTypes['sendInviteEmail'][0])
    {
        return $this->sendInviteEmailAsyncWithHttpInfo($manufacturer_id, $invite_id, $send_invite_email_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sendInviteEmailAsyncWithHttpInfo
     *
     * Send invitation email using HiveCPQ&#39;s email system
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendInviteEmailAsyncWithHttpInfo($manufacturer_id, $invite_id, $send_invite_email_request = null, string $contentType = self::contentTypes['sendInviteEmail'][0])
    {
        $returnType = '';
        $request = $this->sendInviteEmailRequest($manufacturer_id, $invite_id, $send_invite_email_request, $contentType);
    ...
    /**
     * Create request for operation 'sendInviteEmail'
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     * @param  string $invite_id The id of the invite for which an email must be sent (required)
     * @param  \HiveCpq\Client\Generated\Model\SendInviteEmailRequest|null $send_invite_email_request (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendInviteEmailRequest($manufacturer_id, $invite_id, $send_invite_email_request = null, string $contentType = self::contentTypes['sendInviteEmail'][0])
    {

        // verify the required parameter 'manufacturer_id' is set
        if ($manufacturer_id === null || (is_array($manufacturer_id) && count($manufacturer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $manufacturer_id when calling sendInviteEmail'
            );
        }
        ...
        if ($invite_id === null || (is_array($invite_id) && count($invite_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $invite_id when calling sendInviteEmail'
            );
        }



        $resourcePath = '/manufacturers/{manufacturerId}/invites/{inviteId}/sendInviteEmail';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($send_invite_email_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($send_invite_email_request));
            } else {
                $httpBody = $send_invite_email_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
