...
class OutputDocumentApi
{
    ...
    public const contentTypes = [
        'getManufacturersOutputdocuments' => [
            'application/json',
        ],
    ];
    ...
    /**
     * Operation getManufacturersOutputdocuments
     *
     * Get the output document templates for a manufacturer
     *
    ...
    {
        list($response) = $this->getManufacturersOutputdocumentsWithHttpInfo($manufacturer_id, $page, $page_size, $contentType);
        return $response;
    }

    /**
     * Operation getManufacturersOutputdocumentsWithHttpInfo
     *
     * Get the output document templates for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
    ...
    /**
     * Operation getManufacturersOutputdocumentsAsync
     *
     * Get the output document templates for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     ...
     */
    public function getManufacturersOutputdocumentsAsync($manufacturer_id, $page = 0, $page_size = 10, string $contentType = self::contentTypes['getManufacturersOutputdocuments'][0])
    {
        return $this->getManufacturersOutputdocumentsAsyncWithHttpInfo($manufacturer_id, $page, $page_size, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getManufacturersOutputdocumentsAsyncWithHttpInfo
     *
     * Get the output document templates for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
    ...
    /**
     * Create request for operation 'getManufacturersOutputdocuments'
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     * @param  int|null $page View a page of the collection. (optional, default to 0)
     * @param  int|null $page_size Control the size of the returned page. (optional, default to 10)
     ...
     */
    public function getManufacturersOutputdocumentsRequest($manufacturer_id, $page = 0, $page_size = 10, string $contentType = self::contentTypes['getManufacturersOutputdocuments'][0])
    {
        ...
        if ($manufacturer_id === null || (is_array($manufacturer_id) && count($manufacturer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $manufacturer_id when calling getManufacturersOutputdocuments'
            );
        }
        ...
        $resourcePath = '/manufacturers/{manufacturerId}/outputDocumentTemplates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
