...
class SecurityApi
{
    ...
    public const contentTypes = [
        'getManufacturerRoles' => [
            'application/json',
        ],
        'getManufacturersPermissions' => [
            'application/json',
        ],
    ];
    ...
    /**
     * Operation getManufacturerRoles
     *
     * Get the roles of a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     * @param  bool|null $default_role_for_manufacturer_company Search the default roles of the manufacturer (optional)
     * @param  bool|null $default_role_for_distributor_companies Search the default roles of the distributors (optional)
     * @param  string|null $name Search role by name (optional)
     * @param  string|null $company_id Search the roles for a specific company. When omitted it will return the roles of the manufacturer company itself (optional)
    ...
    {
        list($response) = $this->getManufacturerRolesWithHttpInfo($manufacturer_id, $default_role_for_manufacturer_company, $default_role_for_distributor_companies, $name, $company_id, $page, $page_size, $contentType);
        return $response;
    }

    /**
     * Operation getManufacturerRolesWithHttpInfo
     *
     * Get the roles of a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
    ...
    /**
     * Operation getManufacturerRolesAsync
     *
     * Get the roles of a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     ...
     */
    public function getManufacturerRolesAsync($manufacturer_id, $default_role_for_manufacturer_company = null, $default_role_for_distributor_companies = null, $name = null, $company_id = null, $page = 0, $page_size = 10, string $contentType = self::contentTypes['getManufacturerRoles'][0])
    {
        return $this->getManufacturerRolesAsyncWithHttpInfo($manufacturer_id, $default_role_for_manufacturer_company, $default_role_for_distributor_companies, $name, $company_id, $page, $page_size, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getManufacturerRolesAsyncWithHttpInfo
     *
     * Get the roles of a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
    ...
    /**
     * Create request for operation 'getManufacturerRoles'
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     * @param  bool|null $default_role_for_manufacturer_company Search the default roles of the manufacturer (optional)
     * @param  bool|null $default_role_for_distributor_companies Search the default roles of the distributors (optional)
     ...
     */
    public function getManufacturerRolesRequest($manufacturer_id, $default_role_for_manufacturer_company = null, $default_role_for_distributor_companies = null, $name = null, $company_id = null, $page = 0, $page_size = 10, string $contentType = self::contentTypes['getManufacturerRoles'][0])
    {
        ...
        if ($manufacturer_id === null || (is_array($manufacturer_id) && count($manufacturer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $manufacturer_id when calling getManufacturerRoles'
            );
        }
        ...
        $resourcePath = '/manufacturers/{manufacturerId}/roles';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $default_role_for_manufacturer_company,
            'defaultRoleForManufacturerCompany', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $default_role_for_distributor_companies,
            'defaultRoleForDistributorCompanies', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    /**
     * Operation getManufacturersPermissions
     *
     * Search the permissions of a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     * @param  string|null $code Search the permission by its code (optional)
     * @param  int|null $page View a page of the collection. (optional, default to 0)
     * @param  int|null $page_size Control the size of the returned page. (optional, default to 10)
    ...
    {
        list($response) = $this->getManufacturersPermissionsWithHttpInfo($manufacturer_id, $code, $page, $page_size, $role_id, $contentType);
        return $response;
    }

    /**
     * Operation getManufacturersPermissionsWithHttpInfo
     *
     * Search the permissions of a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
    ...
    /**
     * Operation getManufacturersPermissionsAsync
     *
     * Search the permissions of a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getManufacturersPermissionsAsync($manufacturer_id, $code = null, $page = 0, $page_size = 10, $role_id = null, string $contentType = self::contentTypes['getManufacturersPermissions'][0])
    {
        return $this->getManufacturersPermissionsAsyncWithHttpInfo($manufacturer_id, $code, $page, $page_size, $role_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getManufacturersPermissionsAsyncWithHttpInfo
     *
     * Search the permissions of a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
    ...
    /**
     * Create request for operation 'getManufacturersPermissions'
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     * @param  string|null $code Search the permission by its code (optional)
     * @param  int|null $page View a page of the collection. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getManufacturersPermissionsRequest($manufacturer_id, $code = null, $page = 0, $page_size = 10, $role_id = null, string $contentType = self::contentTypes['getManufacturersPermissions'][0])
    {

        // verify the required parameter 'manufacturer_id' is set
        if ($manufacturer_id === null || (is_array($manufacturer_id) && count($manufacturer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $manufacturer_id when calling getManufacturersPermissions'
            );
        }
        ...
        $resourcePath = '/manufacturers/{manufacturerId}/permissions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
