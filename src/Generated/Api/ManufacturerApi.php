...
class ManufacturerApi
{
    ...
    /**
     * Operation getManufacturersList
     *
     * Get manufacturers
     *
    ...
    {
        list($response) = $this->getManufacturersListWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getManufacturersListWithHttpInfo
     *
     * Get manufacturers
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getManufacturersList'] to see the possible values for this operation
    ...
    /**
     * Operation getManufacturersListAsync
     *
     * Get manufacturers
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getManufacturersList'] to see the possible values for this operation
     ...
     */
    public function getManufacturersListAsync(string $contentType = self::contentTypes['getManufacturersList'][0])
    {
        return $this->getManufacturersListAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getManufacturersListAsyncWithHttpInfo
     *
     * Get manufacturers
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getManufacturersList'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'getManufacturersList'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getManufacturersList'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function getManufacturersListRequest(string $contentType = self::contentTypes['getManufacturersList'][0])
    {
