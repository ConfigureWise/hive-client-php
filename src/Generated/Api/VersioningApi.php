...
class VersioningApi
{
    ...
    public const contentTypes = [
        'getManufacturersManufacturerIdContainersContainernameVersions' => [
            'application/json',
        ],
    ];
    ...
    /**
     * Operation getManufacturersManufacturerIdContainersContainernameVersions
     *
     * Retrieve a list of versions for a manufacturer
     *
    ...
    {
        list($response) = $this->getManufacturersManufacturerIdContainersContainernameVersionsWithHttpInfo($manufacturer_id, $name, $status, $type, $ids_in, $contentType);
        return $response;
    }

    /**
     * Operation getManufacturersManufacturerIdContainersContainernameVersionsWithHttpInfo
     *
     * Retrieve a list of versions for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
    ...
    /**
     * Operation getManufacturersManufacturerIdContainersContainernameVersionsAsync
     *
     * Retrieve a list of versions for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     ...
     */
    public function getManufacturersManufacturerIdContainersContainernameVersionsAsync($manufacturer_id, $name, $status = null, $type = null, $ids_in = null, string $contentType = self::contentTypes['getManufacturersManufacturerIdContainersContainernameVersions'][0])
    {
        return $this->getManufacturersManufacturerIdContainersContainernameVersionsAsyncWithHttpInfo($manufacturer_id, $name, $status, $type, $ids_in, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getManufacturersManufacturerIdContainersContainernameVersionsAsyncWithHttpInfo
     *
     * Retrieve a list of versions for a manufacturer
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
    ...
    /**
     * Create request for operation 'getManufacturersManufacturerIdContainersContainernameVersions'
     *
     * @param  string $manufacturer_id ID of the manufacturer company to which you are connecting. (required)
     * @param  string $name Name of the container you want to access. (required)
     * @param  \HiveCpq\Client\Generated\Model\ContainerVersionStatusEnum|null $status (optional)
     ...
     */
    public function getManufacturersManufacturerIdContainersContainernameVersionsRequest($manufacturer_id, $name, $status = null, $type = null, $ids_in = null, string $contentType = self::contentTypes['getManufacturersManufacturerIdContainersContainernameVersions'][0])
    {
        ...
        if ($manufacturer_id === null || (is_array($manufacturer_id) && count($manufacturer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $manufacturer_id when calling getManufacturersManufacturerIdContainersContainernameVersions'
            );
        }
        ...
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling getManufacturersManufacturerIdContainersContainernameVersions'
            );
        }
        ...
        $resourcePath = '/manufacturers/{manufacturerId}/containers/{name}/versions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'ContainerVersionStatusEnum', // openApiType
            'form', // style
            true, // explode
            false // required
        ) ?? []);
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'ContainerVersionTypeEnum', // openApiType
            'form', // style
            true, // explode
            false // required
        ) ?? []);
